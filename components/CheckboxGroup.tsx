...
export const CheckboxGroup: React.FC<CheckboxGroupProps> = ({ question, value, onChange, formData }) => {
    const otherInputName = `${question.id}_other`;
    const otherSelected = value.includes('その他') && question.options?.includes('その他');
    ...
    return (
        <div>
            ...
            <div className="mt-2 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-2">
