...
export const questionnaireData: Section[] = [
    ...
    },
    {
        ...
        questions: [
            ...
            { id: 'symptomCause', level: '2', item: 'Q3', text: 'きっかけや原因として思い当たることはありますか？', type: 'checkbox', options: ['特にない', '転倒した', 'スポーツで痛めた', '仕事で無理をした', '徐々に悪くなった', 'その他'] },
            { id: 'symptomLocation', level: '2', item: 'Q4', text: '痛み・不調がある場所を教えてください', type: 'checkbox', options: ['首', '肩（右・左・両方）', '腰', '股関節（右・左・両方）', '膝（右・左・両方）', '足首（右・左・両方）', 'その他'] },
            { id: 'symptomTrigger', level: '2', item: 'Q5', text: 'どんな時に症状が出ますか？', type: 'checkbox', options: ['歩いている時', '階段を上る時', '階段を下りる時', '立ち上がる時', '座っている時', '寝ている時', '動かし始める時', 'じっとしていても痛い', 'その他'], notes: '複数回答可' },
    ...
    },
    {
        ...
        title: '生活への影響',
        questions: [
            { id: 'dailyLifeImpact', level: '3', item: 'Q7', text: '日常生活で困っていることを教えてください', type: 'checkbox', options: ['歩くのが辛い', '階段の上り下りが辛い', '立ち仕事が辛い', '座り仕事が辛い', '家事ができない', '買い物に行けない', '趣味・スポーツができない', '寝返りが辛い', '寝つきが悪い', '外出が億劫', 'その他'], notes: '複数回答可' },
    ...
    },
    {
        ...
        title: '生活背景',
        questions: [
            { id: 'occupation', level: '5', item: 'Q10', text: '現在のお仕事について教えてください', type: 'checkbox', options: ['会社員・公務員（デスクワーク・立ち仕事・肉体労働）', '自営業', '主婦・主夫', '学生', '無職・退職', 'その他'] },
            { id: 'occupationDetails', level: '5', item: 'Q10-補足', text: '仕事内容の詳細（任意）', type: 'textarea', placeholder: '例：1日8時間パソコン作業' },
            { id: 'familyStructure', level: '5', item: 'Q11', text: 'ご家族構成を教えてください', type: 'radio', options: ['一人暮らし', '配偶者と2人暮らし', '配偶者・子供と同居', '親と同居', 'その他'] },
            { id: 'familySupport', level: '5', item: 'Q11-補足', text: '家族のサポート状況', type: 'radio', options: ['家族のサポートが十分得られる', 'ある程度サポートが得られる', 'あまりサポートが得られない', '一人で生活している'] },
            { id: 'hobbies', level: '5', item: 'Q12', text: '趣味・やりたいことはありますか？', type: 'checkbox', options: ['スポーツ', 'ウォーキング・散歩', '旅行', 'ガーデニング', '料理', '読書', 'その他', '特にない'], notes: '複数回答可' },
        ],
    },
    {
        level: '【レベル6】',
        title: '医療情報',
        questions: [
            { id: 'currentIllnesses', level: '6', item: 'Q13', text: '現在治療中の病気はありますか？', type: 'checkbox', options: ['高血圧', '糖尿病', '心臓の病気', '脳卒中の既往', 'がん', '骨粗鬆症', 'リウマチ', 'その他', '特になし'], notes: '複数回答可' },
            ...
            { id: 'pastSurgeriesDetails', level: '6', item: '', text: '', type: 'text', placeholder: '例：右膝半月板損傷の手術・10年前' },
            { id: 'otherClinics', level: '6', item: 'Q16', text: '今回の症状について、他の医療機関を受診しましたか？', type: 'radio', options: ['はい', 'いいえ'], notes: 'はいの場合は病院名を記入' },
            { id: 'otherClinicsDetails', level: '6', item: '', text: '', type: 'text', placeholder: '例：○○整形外科' },
            { id: 'diagnosis', level: '6', item: 'Q16-補足', text: '診断名（わかれば）', type: 'text', placeholder: '例：変形性膝関節症' },
        ],
    },
    {
        level: '【レベル7】',
...
export const therapistCheckData: TherapistCheckSection = {
    ...
    questions: [
        ...
        { id: 'therapistCheck2', level: '', item: '', text: '生活背景・目標を把握した（Q9-Q12）', type: 'checkbox', options: ['Yes', 'No'] },
