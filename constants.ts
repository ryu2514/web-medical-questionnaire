...
export const questionnaireData: Section[] = [
    ...
    },
    {
        ...
        questions: [
            ...
            { id: 'hobbies', level: '5', item: 'Q11', text: '趣味・やりたいことはありますか？', type: 'checkbox', options: ['スポーツ', 'ウォーキング・散歩', '旅行', 'ガーデニング', '料理', '読書', 'その他', '特にない'], notes: '複数回答可', hasOtherInput: true },
    ...
    },
    {
        ...
        title: '医療情報',
        questions: [
            { id: 'currentIllnesses', level: '6', item: 'Q12', text: '現在治療中の病気はありますか？', type: 'checkbox', options: ['高血圧', '糖尿病', '心臓の病気', '脳卒中の既往', 'がん', '骨粗鬆症', 'リウマチ', 'その他', '特になし'], notes: '複数回答可', hasOtherInput: true },
            ...
            { id: 'currentMedications', level: '6', item: 'Q13', text: '現在飲んでいるお薬はありますか？', type: 'radio', options: ['あり（お薬手帳をお持ちください）', 'なし'] },
            { id: 'pastSurgeries', level: '6', item: 'Q14', text: '過去に大きな手術やケガをしたことはありますか？', type: 'radio', options: ['あり', 'なし'], notes: 'ありの場合は内容を記入' },
            ...
            { id: 'otherClinics', level: '6', item: 'Q15', text: '今回の症状について、他の医療機関を受診しましたか？', type: 'radio', options: ['はい', 'いいえ'], notes: 'はいの場合は病院名を記入' },
            { id: 'otherClinicsDetails', level: '6', item: '', text: '', type: 'text', placeholder: '例：○○整形外科', conditionalOn: 'otherClinics', conditionalValue: 'はい' },
            { id: 'diagnosis', level: '6', item: 'Q15-補足', text: '診断名（わかれば）', type: 'text', placeholder: '例：変形性膝関節症' },
        ],
    },
    {
        level: '【レベル7】',
